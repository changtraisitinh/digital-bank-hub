...
SERVICE_NAME="dibank-transaction-service"
PORT=8103
...
docker build -t dibank-transaction-service:latest .
...
kubectl get pods -l app=dibank-transaction-service
kubectl get services dibank-transaction-service

echo "✅ Deployment completed!"

# Forward the service port to your local machine
sleep 5
kubectl port-forward service/dibank-transaction-service 8102:8102